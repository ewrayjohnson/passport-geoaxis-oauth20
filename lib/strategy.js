...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://gxisaccess.gxaccess.com/ms_oauth/oauth2/endpoints/oauthservice/authorize';
  options.tokenURL = options.tokenURL || 'https://gxisaccess.gxaccess.com/ms_oauth/oauth2/endpoints/oauthservice/tokens';
  ...
  this.name = 'geoaxis';
  this._userProfileURL = options.userProfileURL || 'https://gxisaccess.gxaccess.com/ms_oauth/resources/userprofile/me';
